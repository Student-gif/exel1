...
highprep=[
('К.г.н.,доц.Шагаров Л.М.',15778),
('ст. преп.Аверьянова Е.А.',24360),
('Агазарян Н.В.',21805),
('проф.Амироков М.А.',22256),
('асс.Аникушин А.В.',23209),
('доц.Анфалова А.Ю.',21335),
('доц.Аравившвили Д.Э.',20966),
('доц.Арефинкина Е.Г.',22383),
('доц.Ашалян Л.Н.',20640),
('доц.Батенева И.А.',18870),
('ст.преп.Блинов А.В.',15973),
('доц.Блохин К.А.',19047),
('доц.Бобылев В.В.',19080),
('Ст.преп. Брагина Н.М.',43399),
('проф.Богучарский А.В.',24009),
('Бригида В.С.',17945),
('доц.Векуа Н.Н.',16245),
('асс.Вишневский А.Е.',24388),
('проф.Воротников В.И.',26380),
('доц.Гадицкая М.А.',25542),
('проф.Гварлиани Т.Е.',23203),
('асс.Горбунова Т.Л.',26512),
('доц.Гревцова В.И.',23669),
('Гудкова Н.К.',22274),
('доц.Гусарова Н.Н.',26212),
('доц.Давтян А.Р.',22044),
('ст. преп.Даниленкова Е.Б.',23687),
('доц.Дегтярев П.А.',27630),
('Джинджолия Г.П.',26773),
('доц.Дмитриченко Е.В.',28617),
('ст. преп.Догадов Д.И.',20850),
('доц.Дружинина В.В.',26825),
('доц.Дуженко М.В.',24822),
('ст. преп.Жолобова Н.М.',28221),
('ст. преп.Закарая М.О.',27718),
('ст. преп.Замуруева Я.А.',30281),
('Замышляева Д.Н.',33806),
('проф.Иванников И.А.',29043),
('доц.Иванов П.Ф.',25220),
('асс.Иванова К.П.',25802),
('доц.Игошев М.В.',25415),
('ст. преп.Иджиян Р.М.',28236),
('доц.Ильинская О.Г.',34937),
('доц.Казакова Н.А.',29139),
('доц.Камкия Б.А.',27838),
('доц.Камкия Ф.Г.',30220),
('Капец В.П.',25424),
('Капец О.В.',25859),
('ст. преп.Каргин Ф.Н.',28596),
('доц.Киютина Т.Н.',34160),
('проф.Козлов В.И.',27431),
('доц.Кочетков Н.М.',36383),
('ст. преп.Кошевая Н.С.',34068),
('Круглов Д.А.',30504),
('доц.Лебедева Е.И.',28888),
('асс.Левандовская Н.А.',32763),
('асс.Легкая Е.Ф.',29766),
('ст. преп.Лендьел Н.Я.',34921),
('ст. преп.Литовченко А.А.',35586),
('Логинова Л.В.',32973),
('Лотоцкий В.Д.',36654),
('ст.преп.Максимова О.В.',34310),
('ст. преп.Маринич Л.Р.',34877),
('асс.Медведева Е.Г.',29926),
('ст. преп.Мельникова В.С.',37204),
('проф.Мининков Н.А.',35677),
('Мининкова Л.В.',34928),
('ст. преп.Миронова Ж.В.',34808),
('доц.Мительская Ж.З.',39716),
('Митрохина Н.В.',38463),
('доц.Михайлюк М.Н.',39029),
('ст. преп.Мицкевич Я.К.',39792),
('ст. преп.Небеснюк У.А.',39124),
('ст. преп.Невмержицкая Ю.П.',38561),
('проф.Новоселова С.Ю.',38935),
('ст. преп.Оганесян А.К.',38891),
('ст. преп.Орехова Л.О.',36334),
('асс.Паукова К.М.',35363),
('доц.Пилия Д.Э.',34523),
('Подрепный Е.И.',42473),
('ст. преп.Подскребкина О.А.',39512),
('доц.Покивайлова Е.А.',36559),
('доц.Постников В.В.',41277),
('доц.Поташова И.Ю.',41552),
('ст. преп.Прокипчук Л.И.',44157),
('ст. преп.Пчелинцев В.А.',40669),
('доц.Разина Е.В.',31905),
('ст. преп.Резван В.Д.',31770),
('доц.Руденко Н.С.',40140),
('доц.Рыбакова Л.В.',39306),
('ст. преп.Рыбалко А.А.',37357),
('проф.Рыбалко А.Е.',37732),
('ст. преп.Савенко А.С.',36972),
('Сарычев И.А.',39708),
('доц.Свинцицкая Л.К.',44609),
('Серебряный Р.А.',44806),
('проф.Сидорова Т.А.',41080),
('Скипина К.П.',39284),
('доц.Смеречинская Н.М.',44577),
('доц.Соколова Г.Н.',41222),
('доц.Соловьева В.В.',41449),
('ст. преп.Соломина О.Е.',42731),
('доц.Сорокожердьев В.В.',43148),
('доц.Суворова Н.А.',41791),
('доц.Суханова И.З.',41932),
('доц.Телегина О.В.',40440),
('доц.Тильба П.А.',37645),
('проф.Толстых Т.Н.',47462),
('асс.Уюткин Н.Н.',43588),
('ст. преп.Ханжина Л.Н.',42194),
('ст. преп.Цатурян С.А.',49486),
('проф.Чалян В.Г.',41430),
('асс.Чекмарев А.А.',45109),
('доц.Чжу О.П.',37674),
('ст. преп.Шамсутдинова О.А.',50569),
('доц.Шмат Е.В.',39156),
('ст. преп.Элизбарян З.В.',56924),
('доц.Эмексузян Р.Р.',61309),
('доц.Юдин В.А.',45058),
('доц.Ярцева И.К.',52936),
]
...
#cursor.executemany('INSERT INTO PREPODS(PREPODS,IdTeacher) VALUES (?,?)',highprep)
#conn.commit()
